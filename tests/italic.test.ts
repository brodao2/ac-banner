...
describe("test build decorators with italic", () => {
  ...
  it("...and font alphabet", async () => {
    ...
    const banner: string[] = buildBanner("AC Banner", data, { font: "alphabet", italic: true });
  ...
  it("...and font ansi-with-shadow", async () => {
    const data: TDataBanner = defaultData;
    const banner: string[] = buildBanner("AC Banner", data, { font: "ansi-with-shadow", italic: true });
  ...
  it("...and font bar", async () => {
    const data: TDataBanner = defaultData;
    const banner: string[] = buildBanner("AC Banner", data, { font: "bar", italic: true });
